...
- Additionally, install Tesseract-OCR(3.2) and take note of its installation path. Need to replace that path in ```fetch_card_owned_info.py``` file. Set env variable ```TESSDATA_PREFIX``` for tessdata.
